...
import { type Chain, type PoolWithTimeseries, type UniswapLikeEcosystemCharts, type TokenV2VolumeWithChartData, type ExchangeTransaction, type Transaction, type ChainItem } from "@covalenthq/client-sdk";
import { type DECODED_ACTION, type DECODED_EVENT_CATEGORY } from "../constants/shared.constants";
...
export interface DecodedTransactionProps {
    chain_name: Chain;
    tx_hash: string;
    setTxMetadata?: React.Dispatch<React.SetStateAction<Option<DecodedTransactionMetadata | null>>>;
}
...
export type DecodedTransactionMetadata = Omit<Transaction, "log_events" | "dex_details" | "nft_sale_details" | "lending_details" | "safe_details">;
