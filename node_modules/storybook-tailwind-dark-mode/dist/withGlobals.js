...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } /* eslint-env browser */
var withGlobals = function withGlobals(StoryFn, context) {
  var _useGlobals = (0, _previewApi.useGlobals)(),
    _useGlobals2 = _slicedToArray(_useGlobals, 1),
    globals = _useGlobals2[0];
  var darkMode = globals.darkMode;
  var className = globals.className || "dark";
  var isInDocs = context.viewMode === "docs";
  (0, _previewApi.useEffect)(function () {
    var selector = isInDocs ? "#anchor--".concat(context.id, " .sb-story") : "#storybook-root";
    console.log(globals);
...
var changeBackgroundMode = function changeBackgroundMode(selector, _ref) {
